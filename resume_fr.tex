...
\fcolorbox{white}{white}{\begin{minipage}[c][0.95\textheight][t]{0.69\linewidth}
		...
		%\textcolor{softcol}{\hrule}
		\cvevent{2015 - 2019}{Électronicien}{Athénée Royal d'Esneux}{Certificat d'Enseignement Secondaire Supérieur (CESS). Orientation : Technicien en Électronique.,Mémoire : Mise en œuvre d'un hexapode suiveur de ligne.,Brevet de Secouriste d'entreprise.,Diplôme d'électricien A2.}
